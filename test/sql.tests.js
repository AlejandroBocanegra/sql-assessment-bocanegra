...
describe("A proficient SQL developer", () => {
  it("should be able to create a table successfully", () => {
  ...
  it("should be able to insert rows into a table", () => {
  ...
  it("should be able to find data in a table by keyword", () => {
    const createTableSql = fs.readFileSync('src/01-create-table.sql', 'utf8');
    const insertSql = fs.readFileSync('src/02-insert-rows.sql', 'utf8');
  ...
  it("should be able to implement SQL functions like Count", () => {
    const createTableSql = fs.readFileSync('src/01-create-table.sql', 'utf8');
    const insertSql = fs.readFileSync('src/02-insert-rows.sql', 'utf8');
  ...
  it("should be able to remove items from a table", () => {
    const createTableSql = fs.readFileSync('src/01-create-table.sql', 'utf8');
    const insertSql = fs.readFileSync('src/02-insert-rows.sql', 'utf8');
